              ...
              return (
                <div key={dept} className="mb-16">
                  <motion.div
                    ...
                    style={{ borderBottom: '1px solid rgba(28,20,24,0.1)', paddingBottom: '12px' }}
                  >
                    <span className="text-[10px] uppercase tracking-[0.35em] font-bold" style={{ color: 'var(--red)' }}>
                      {dept}
                    </span>
                    <span className="text-[10px]" style={{ color: 'rgba(28,20,24,0.2)' }}>
                  ...
                  >
                    {members.map((member, i) => (
                      <motion.div
                        ...
                        style={{ borderBottom: '1px solid rgba(28,20,24,0.08)' }}
                      >
                        {/* Avatar */}
                        <div
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[11px]" style={{ color: 'rgba(28,20,24,0.38)' }}>{member.role}</p>
                        </div>
                        ...
                        <div className="hidden sm:flex flex-wrap gap-1.5 shrink-0 max-w-[260px] justify-end">
                          {member.skills.slice(0, 3).map((skill) => (
                            <span key={skill} className="text-[10px] px-2 py-0.5 rounded-md"
                              style={{ background: `${member.color}12`, border: `1px solid ${member.color}22`, color: 'rgba(28,20,24,0.45)' }}>
                              {skill}
                            </span>
                          ))}
                        </div>
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: 'var(--bg-0)' }}>
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10">
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
            ...
            <motion.p variants={fadeInUp} className="text-sm leading-relaxed mb-10 max-w-md" style={{ color: 'rgba(28,20,24,0.42)' }}>
