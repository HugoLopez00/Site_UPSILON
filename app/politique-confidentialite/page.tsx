  ...
  return (
    <div className="pt-32 pb-24 bg-[#07070a]">
      <div className="max-w-[800px] mx-auto px-6">
        <h1 className="text-3xl font-extrabold tracking-tight text-[#f5f5f7] mb-3">Politique de confidentialité</h1>
        <p className="text-sm text-[rgba(245,245,247,0.4)] mb-12">Conformément au RGPD (Règlement UE 2016/679) · Dernière mise à jour : juin 2025</p>

        <div className="space-y-10 text-sm text-[rgba(245,245,247,0.65)] leading-relaxed">
          <section>
            <h2 className="text-base font-bold text-[#f5f5f7] mb-3">1. Responsable du traitement</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f5f5f7] mb-3">4. Durée de conservation</h2>
            <p>
              Les données issues des formulaires de contact sont conservées <strong className="text-[rgba(245,245,247,0.85)]">3 ans</strong> à
              compter du dernier contact. Les candidatures non retenues sont supprimées après <strong className="text-[rgba(245,245,247,0.85)]">6 mois</strong>.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f5f5f7] mb-3">5. Vos droits</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#f5f5f7] mb-3">6. Cookies</h2>
            <p>
