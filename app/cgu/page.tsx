  ...
  return (
    <div className="pt-32 pb-24 bg-[#F5F1EC]">
      <div className="max-w-[800px] mx-auto px-6">
        <h1 className="text-3xl font-extrabold tracking-tight text-[#1C1418] mb-3">
          Conditions Générales d&apos;Utilisation
        </h1>
        <p className="text-sm text-[rgba(28,20,24,0.4)] mb-12">Version en vigueur au 1er juin 2025</p>

        <div className="space-y-10 text-sm text-[rgba(28,20,24,0.65)] leading-relaxed">
          <section>
            <h2 className="text-base font-bold text-[#1C1418] mb-3">1. Objet</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#1C1418] mb-3">2. Accès au site</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#1C1418] mb-3">3. Utilisation des formulaires</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#1C1418] mb-3">5. Comportements interdits</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#1C1418] mb-3">6. Limitation de responsabilité</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#1C1418] mb-3">7. Modification des CGU</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-[#1C1418] mb-3">8. Droit applicable et juridiction</h2>
            <p>
          ...
          <div className="card rounded-xl p-5 border border-black/[0.08]">
            <p className="text-xs text-[rgba(28,20,24,0.5)]">
